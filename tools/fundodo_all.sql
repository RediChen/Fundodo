...
(1, '管理者', 'admin', 'admin', '$2y$10$.eJkgWzwYCQojJwc7pcVc.SC8kwFerDdioNvxBoSWQdo0ApHPHd.e', '1', 20, 1, '1990-01-19', '0978543021', 'admin@outlook.com', '管理者', 'admin.png', '翻肚肚總部', 4, 320, '2023-04-10 12:00:00', NULL),
...
(1, '玩出好感情！與狗兒的互動遊戲課', '與狗兒的線上遊戲課程，一起練習合作遊戲，加深彼此的信任關係！', NULL, 1200, '2024-12-18 11:02:37', NULL),
(2, '【狗狗教養實作】線上體驗課', '6/13 (四) ：不同狗兒教養方式全面解析 ！+ 吠叫案例詳解 【好評加開！報名截止日到 6/12（三） 23:59】6/23 （日）：破解常見狗狗教養迷思！+ 戶外撿拾案例詳解【報名截止日到 6/21（五） 23:59】', NULL, 350, '2024-12-18 19:32:47', NULL),
(3, '正向教養生活課－吃飯啃咬', '餵正餐時狗兒愛吃不吃，非得要過一兩小時才肯吃光，一邊趕上班一邊配合狗兒步調，情緒好崩潰！散步又會到處撿拾，不知道吃到什麼東西，實在很擔心牠的安全。面對這類生活裡經常發生的養狗情境，如何才能找到最理想的解決方案？', NULL, 1200, '2024-12-19 00:00:50', NULL),
(4, '正向教養生活課－洗澡美容', '每月固定要去美容室洗澡的狗兒，總是對於前往表現得異常緊張，拼命往反方向走；甚至對美容師表現躁動，不給剪指甲也不給梳理。面對這類生活裡經常發生的養狗情境，如何才能找到最理想的解決方案？', NULL, 600, '2024-12-19 07:28:00', NULL),
(5, '正向教養生活課－看醫生', '正向教養是以「人狗關係」為核心的沈浸式課程，透過學習如何處理與狗兒的關係，找到問題解法，建立起與狗兒之間的良好溝通。想進一步知道生活中有哪些情境可以運用正向教養嗎？', NULL, 650, '2024-12-19 09:34:01', NULL),
(6, 'Chew Box 操作守則', '如同我們壓力大的時候，會依靠美食來紓壓，「啃咬」除了滿足狗兒的食物多樣性需求，也是狗兒調節情緒的方式，Chew Box 能夠給予狗狗自主使用情緒調節工具的機會。', NULL, 1200, '2024-12-19 20:51:10', NULL),
(7, '2024 狗狗正向教養 6 週高階課程', '在正向教養中，我們會重新學習擁抱自己的情緒，從不同的視角看看與狗兒的關係，重新釐清溫柔與堅定的意涵。', NULL, 9000, '2024-12-20 11:58:19', NULL),
(8, '安全感與五大需求講座', '一些狗兒常見的行為問題可能是源於需求為被滿足，而理解狗兒的需求便是解決行為問題及創造更和諧的人狗關係的第一步。', NULL, 1200, '2024-12-21 04:14:20', NULL),
(9, '2024 狗狗正向教養 6 週初階課程', '透過正向教養工作坊，一起了解溫和與堅定背後的含義，發掘與狗兒生活的更多可能性！', NULL, 9000, '2024-12-21 11:32:23', NULL),
(10, '吠叫講座－聽懂狗兒叫什麼', '吠叫是狗兒用來傳遞訊息、表達情緒的一種方式。理解狗兒吠叫背後想要傳遞的訊息，滿足狗兒的需求，才能最終改善狗兒的吠叫行為並建立良好人狗關係。', NULL, 1200, '2024-12-21 12:46:24', NULL),
(11, '2024 狗狗正向教養 6 週中階課程', '在正向教養中，我們會重新學習擁抱自己的情緒，從不同的視角看看與狗兒的關係，重新釐清溫柔與堅定的意涵。', NULL, 9000, '2024-12-22 05:13:35', NULL),
(12, '看懂狗兒在說什麼！肢體語言講座課程', '學習狗兒的肢體語言，理解狗兒在表達什麼，尊重與滿足狗兒的需求，才能建立起雙向溝通的管道，增進人狗關係。', NULL, 1200, '2024-12-22 10:39:38', NULL),
(13, '壓力與情緒復原力講座', '當狗兒的壓力滿到臨界點時，常常伴隨著激烈反應。一些常見的行為問題，如：吠叫、攻擊，背後的原因都可能是因為「累積過多壓力」。', NULL, 1200, '2024-12-22 18:45:42', NULL),
(14, '狗狗社交講座(上) - 狗兒社交語言大解析', '- 掌握3大玩樂訊號- 6個社交肢體訊號- 4種不同互動狀態的判別（和平社交、激烈玩樂、過度社交、吵架）了解狗兒的社交語言，正確判斷狗兒的社交狀態，累積更多良好社交體驗！', NULL, 1200, '2024-12-23 06:56:53', NULL),
(15, '社交講座(下) - 良好的社交守則', '社交挫敗可能導致狗兒出現對其他狗兒的攻擊行為。講座裡將告訴你怎麼安排狗兒良好的社交活動，避免狗兒社交挫敗，重新建立好的社交經驗!', NULL, 1200, '2024-12-23 21:07:58', NULL),
(16, '完整社交講座大合集', '看懂狗兒的社交語言，評估狗兒的社交狀態，預防社交挫敗的發生。- 掌握3大玩樂訊號- 6個社交肢體訊號- 4種不同互動狀態的判別（和平社交、激烈玩樂、過度社交、吵架）', NULL, 2280, '2024-12-24 13:37:07', NULL),
(17, '嗅聞講座', '透過嗅聞，狗兒可以建構出一個世界! 嗅聞對狗兒來說是很重要的一個需求和減壓方式。', NULL, 1200, '2024-12-25 02:03:10', NULL),
(18, '戶外狗兒也穩定！狗兒專注力 Level Up 實戰訓練課程', '【可無限次重複觀看！】現在開通課程，即加贈 2 篇 Bonus 指令「不衝門」、「等等」訓練！課程將會透過一整套以「人狗信任關係」為核心設計的訓練遊戲，共 9 大指令來鍛鍊我們抓住狗兒的注意力、培養 3 大關鍵能力！透過這些訓練遊戲，培養狗兒在戶外的專注力和穩定性，並強化我們的訓練技巧，過程中更能加深我們和狗兒的信任關係！', NULL, 2900, '2024-12-25 11:09:11', NULL),
(19, '青少年狗！線上行為知識講座', '從抓狂到合作，培養情緒穩定的青少年狗！', NULL, 1200, '2024-12-25 15:12:19', NULL),
(20, '玩出好狗兒！教會狗兒玩玩具、放嘴以及拾回', '可無限次重複觀看！！和狗狗玩玩具，增加狗狗的快樂清單! 這場講座除了會教拔麻怎麼玩玩具以外，也會教導 No 指令的運用和拾回訓練，讓拔麻多一個可以跟狗狗一起快樂的活動！', NULL, 1900, '2024-12-25 18:31:19', NULL),
(21, '戶外遊戲、STAY及召回指令', '可無限次重複觀看！！和狗狗在戶外一起玩遊戲，提升好感情學會STAY和召回，關鍵時刻一召保命', NULL, 2500, '2024-12-26 04:48:21', NULL),
(22, '帶狗出國二三事 - 狗兒出國分享會', '帶狗出國不是夢？帶狗出國的文件流程與訓練細節大公開', NULL, 650, '2024-12-26 09:56:23', NULL),
(23, 'Plenty in Life is Free - 導讀會', '當我們釐清理想中與狗兒關係的樣子，訓練背後對於狗兒和關係的影響，我們的期待與目標，才能找到最合適於我們的練習方式', NULL, 650, '2024-12-26 20:26:23', NULL);
