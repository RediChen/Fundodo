...
(9, '2024 狗狗正向教養 6 週初階課程', '透過正向教養工作坊，一起了解溫和與堅定背後的含義，發掘與狗兒生活的更多可能性！', NULL, 8000, '2024-02-21 11:32:23', NULL),
...
(14, '狗狗社交講座(上) - 狗兒社交語言大解析', '- 掌握3大玩樂訊號- 6個社交肢體訊號- 4種不同互動狀態的判別（和平社交、激烈玩樂、過度社交、吵架）了解狗兒的社交語言，正確判斷狗兒的社交狀態，累積更多良好社交體驗！', NULL, 1300, '2024-03-13 06:56:53', NULL),
...
(23, 'Plenty in Life is Free - 導讀會', '當我們釐清理想中與狗兒關係的樣子，訓練背後對於狗兒和關係的影響，我們的期待與目標，才能找到最合適於我們的練習方式', NULL, 650, '2024-05-13 20:26:23', '2024-06-09 01:25:31');
...
(3, 'Farmina 法米納VD-6 Vet Life 犬用泌尿道磷酸銨鎂結石配方', '預防和管理磷酸銨鎂結石，維持泌尿系統健康。', 1, 1, 1190, '2024-02-19 00:00:00', 50, 0),
(4, 'Farmina 法米納VD-8 Vet Life 犬用草酸鈣結石配方', '針對草酸鈣結石問題設計，幫助防止結石形成。', 1, 1, 1190, '2024-02-19 00:00:00', 45, 0),
...
(278, '汪喵星球情緒好放鬆保養粉', ' 適合有長期情緒壓力困擾的毛孩每日補充 嚴選國際專利成分與複方設計，透過天然胺基酸，幫助毛孩減少壓力！', 0, 24, 480, '2024-05-29 00:00:00', 37, 0),
...
(1, '管理者', 'admin', 'admin', '$2y$10$DvWvj/vJt7ifvbKXQkWlU.ry9MbgiqhDVZ9LF9ZhtbUoPw2.jsu7i', '1', 20, 1, '1990-01-19', '0900000000', 'admin@outlook.com', '龜龜', '1.png', '聖德學院', 6, 312, '2023-04-10 12:00:00', NULL),
(2, '邱越靈', 'Betty', 'betty119', '$2y$10$y37bo6jz2.flu8eXPs9xH.QhU87eO36Hy.XFYdccPr.G/TSXXxgVS', '2', 0, 3, '1997-09-20', '0960008329', 'mallette7168@outlook.com', '', '0', '新光路16號6樓', 8, 412, '2023-04-10 22:02:02', NULL),
...
(4, '詹庭樂', 'Sarah', 'sarah38', '$2y$10$9lRcbb82MFQQKAf/UmbT9e6KpnysEL8esTxeEsLrLzIQWJNtmOXAS', '2', 3, 1, '1962-11-21', '0930290396', 'cullen7136@outlook.com', '', '0', '朝富一街56號', 8, 407, '2023-04-11 13:39:19', NULL),
...
(14, '陳啟振', 'trenton9996', 'ton999', '$2y$10$ocrILLSwkYZX1Gw9saZsXeivaGUEjYvFcKPqvp0P9YH3Lg3Viydl.', '1', 0, 1, '1971-10-10', '0934179509', 'trenton9996@gmail.com', '', '0', '民生南路62號之4', 11, 600, '2023-04-14 08:14:21', NULL),
...
(24, '許懋朋', 'fox', 'fox543', '$2y$10$eNjEadRWaQxN6d.OHq1aKuskYQCWkiI6gJqlpDzfh4zuJfxJbtz9O', '1', 3, 1, '2011-10-14', '0986121777', 'swift518@gmail.com', '', '0', '新生路60號', 19, 961, '2023-04-18 12:53:24', NULL),
...
(51, '程祟衛', 'dog', 'dog353', '$2y$10$UhlyK8GP5/5A4g9HK5dlA.1bqRIGbTwk4ipvdJ0UTWfTuuiJeJXN2', '1', 0, 1, '2002-09-25', '0963099024', 'robert3769@gmail.com', '', '0', '和睦路團管區巷36號2樓', 17, 260, '2023-04-28 16:25:16', NULL),
...
(57, '王嬡立', 'pudding', 'pudding404', '$2y$10$wlDxrxmS0SaSCI/Uwf0DVuJaMxdJS060OfvFqSJsRbakZi5JniKHO', '2', 0, 1, '2007-05-05', '0963186789', 'garland7149@gmail.com', '', '0', '台元街28號4樓之13', 6, 302, '2023-05-01 09:31:48', NULL),
...
(69, '孫德霄', 'Carl', 'carl987', '$2y$10$.V8QdCtrNrYOVOqzh71gsOI9YUDGq.iB2iRtfIoaFY5H/MCNkWIim', '1', 0, 1, '1992-11-03', '0925550569', 'carl4094@yahoo.com', '', '0', '大和街6號4樓', 14, 735, '2023-05-05 17:29:54', NULL),
...
(214, '康嘉輝', 'Dylan', 'dylan', '$2y$10$/2Su8FXsxvNzk8YreJl7XeDMNVEJKOxJF/q4V7c60.dPU68.KFV4K', '1', 0, 1, '1997-07-02', '0924101752', 'dylan741@gmail.com', '', '0', '大連路１段10號11樓', 8, 406, '2023-07-01 20:32:18', NULL),
...
(265, '洪寶許', 'gorilla', 'money', '$2y$10$SOmBorGDtkxCMrUXkOdBneSwj2BIx8.y9GxbTUiHGgWy3812P9QR6', '1', 0, 1, '1964-11-06', '0921119026', 'richard5020@outlook.com', '', '0', '大同東路23號', 12, 613, '2023-07-20 15:21:04', NULL),
...
(301, '黃梓津', 'kathryn906', 'kathryn906', '$2y$10$17egUKtwR8F6Xbsdy3uU1ON7vwhpb0khy/bHGrBa0eRbngdLOAJFG', '2', 0, 1, '1985-08-14', '0938498201', 'kathryn9679@outlook.com', '', '0', '僑信街54號', 9, 510, '2023-08-05 05:56:33', NULL);
...
--
ALTER TABLE `products_tags`
  MODIFY `id` int(13) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=145;
...
--
ALTER TABLE `prod_images`
  MODIFY `id` bigint(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=378;
