                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="coupontype" id="inlineRadio1" value="1" <?= $row["coupontype"] == 1 ? "checked" : "" ?>>
                                        <label class="form-check-label" for="inlineRadio1">%數折扣</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="coupontype" id="inlineRadio2" value="2" <?= $row["coupontype"] == 2 ? "checked" : "" ?>>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="請輸入百分比或金額" aria-label="請輸入百分比或金額" aria-describedby="value_unit" name="value" value="<?= $row["value"] ?>">
                                        <span class="input-group-text" id="value_unit"><?= $row["coupontype"] == 1 ? "%" : "元" ?></span>
